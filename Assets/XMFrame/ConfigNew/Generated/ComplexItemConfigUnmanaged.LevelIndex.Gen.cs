...
{
    // ComplexItemConfigUnmanaged 的部分类 - LevelIndex索引
    public partial struct ComplexItemConfigUnmanaged
    {
        /// <summary>
        /// LevelIndex 索引结构体
        /// </summary>
        public struct LevelIndexIndex : IConfigIndexGroup<global::XM.ConfigNew.Tests.Data.ComplexItemConfigUnmanaged>, IEquatable<LevelIndexIndex>
        {
            // 索引字段
    ...
    /// LevelIndex 索引扩展方法
    /// </summary>
    public static class ComplexItemConfigUnmanaged_LevelIndexIndexExtensions
    {
        /// <summary>
        /// 获取索引对应的配置数据列表(多值索引)
        /// </summary>
        ...
        public static NativeArray<global::XM.ConfigNew.Tests.Data.ComplexItemConfigUnmanaged> GetVals(this ComplexItemConfigUnmanaged.LevelIndexIndex index, Allocator allocator)
        {
            // TODO: 实现多值索引查询逻辑
