...
{
    // ComplexItemConfigUnmanaged 的部分类 - FullIndex索引
    public partial struct ComplexItemConfigUnmanaged
    {
        /// <summary>
        /// FullIndex 索引结构体
        /// </summary>
        public struct FullIndexIndex : IConfigIndexGroup<global::XM.ConfigNew.Tests.Data.ComplexItemConfigUnmanaged>, IEquatable<FullIndexIndex>
        {
            // 索引字段
    ...
    /// FullIndex 索引扩展方法
    /// </summary>
    public static class ComplexItemConfigUnmanaged_FullIndexIndexExtensions
    {
        /// <summary>
        /// 获取索引对应的配置数据(唯一索引)
        /// </summary>
        ...
        public static global::XM.ConfigNew.Tests.Data.ComplexItemConfigUnmanaged GetVal(this ComplexItemConfigUnmanaged.FullIndexIndex index)
        {
            // TODO: 实现索引查询逻辑
