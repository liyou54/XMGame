...
namespace XM.Contracts
{
    ...
    /// 类型转换器接口
    /// </summary>
    internal interface ITypeConverter<TSource, TTarget>
    {
        /// <summary>
        /// 将源类型转换为目标类型
        /// </summary>
        public abstract bool Convert(TSource source,string modName, out TTarget target);
    }

    public abstract class TypeConverterBase<TSource, TTarget, This> : ITypeConverter<TSource, TTarget> where This : new()
    {
        private static This __instance;

        public static This I
        {
            get
            {
                if (__instance == null)
    ...
    public interface IConfigManager : IManager<IConfigManager>
    {
