...
public partial struct TestConfigUnManaged
{
    ...
    public XBlobMap<Int32, XBlobMap<Int32, XBlobArray<NestedConfigUnManaged>>> ConfigDict;
...
public partial struct TestConfigUnManaged
{
    ...
    public string ToString(object dataContainer)
    {
        ...
        sb.Append(", ");
        // XBlobMap
        sb.Append("ConfigDict=");
        if (container.HasValue)
            AppendMap_ConfigDict(sb, container.Value, ConfigDict);
        else
            sb.Append("XBlobMap<Int32, XBlobMap<Int32, XBlobArray<NestedConfigUnManaged>>>[?]");
        sb.Append(", ");
        // 普通字段：直接打印
    ...
    /// <summary>辅助方法：打印 XBlobMap ConfigDict</summary>
    private static void AppendMap_ConfigDict(global::System.Text.StringBuilder sb, global::XBlobContainer container, XBlobMap<Int32, XBlobMap<Int32, XBlobArray<NestedConfigUnManaged>>> map)
    {
        int len = map.GetLength(container);
        sb.Append("{");
        // Map 打印前 5 对
