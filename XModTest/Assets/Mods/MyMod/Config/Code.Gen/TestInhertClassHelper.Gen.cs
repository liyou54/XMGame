...
namespace XM.Editor.Gen
{
    ...
    public class TestInhertClassHelper : ConfigClassHelper<global::XM.Editor.Gen.TestInhert, global::XM.Editor.Gen.TestInhertUnmanaged>
    {
        ...
        {
            // 解析 CfgS 引用字符串
            var cfgSString = global::XM.Contracts.Config.ConfigParseHelper.GetXmlFieldValue(configItem, "Link");
            if (string.IsNullOrEmpty(cfgSString))
            {
                return default;
            }

            if (global::XM.Contracts.Config.ConfigParseHelper.TryParseCfgSString(cfgSString, "Link", out var modName, out var cfgName))
            {
                return new global::XM.Contracts.Config.CfgS<TestConfig>(new global::XM.Contracts.Config.ModS(modName), cfgName);
            }

            global::XM.Contracts.Config.ConfigParseHelper.LogParseError(context, "Link", $"无法解析 CfgS 字符串: {cfgSString}");
            return default;
        }
        ...
        public virtual void EstablishLinks(
            global::XM.Editor.Gen.TestInhert config,
            ref global::XM.Editor.Gen.TestInhertUnmanaged data,
            XM.ConfigDataCenter.ConfigDataHolder configHolderData)
        {
            // TODO: 实现 Link 双向引用
