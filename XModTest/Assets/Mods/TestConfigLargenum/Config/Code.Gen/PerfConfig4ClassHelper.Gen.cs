...
public sealed class PerfConfig4ClassHelper : ConfigClassHelper<PerfConfig4, PerfConfig4UnManaged>
{
    ...
    static PerfConfig4ClassHelper()
    {
        ...
        CfgS<PerfConfig4UnManaged>.Table = new TblS(new ModS(__modName), __tableName);
    ...
    private static CfgS<PerfConfig4UnManaged> ParseId(XmlElement configItem, ModS mod, string configName, in ConfigParseContext context)
        {
            try
            {
