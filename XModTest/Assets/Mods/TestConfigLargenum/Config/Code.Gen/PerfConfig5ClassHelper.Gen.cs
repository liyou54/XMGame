...
public sealed class PerfConfig5ClassHelper : ConfigClassHelper<PerfConfig5, PerfConfig5UnManaged>
{
    ...
    static PerfConfig5ClassHelper()
    {
        ...
        CfgS<PerfConfig5UnManaged>.Table = new TblS(new ModS(__modName), __tableName);
    ...
    private static CfgS<PerfConfig5UnManaged> ParseId(XmlElement configItem, ModS mod, string configName, in ConfigParseContext context)
        {
            try
            {
