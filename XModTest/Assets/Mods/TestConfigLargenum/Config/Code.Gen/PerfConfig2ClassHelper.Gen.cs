...
public sealed class PerfConfig2ClassHelper : ConfigClassHelper<PerfConfig2, PerfConfig2UnManaged>
{
    ...
    static PerfConfig2ClassHelper()
    {
        ...
        CfgS<PerfConfig2UnManaged>.TableName = __tableName;
        try
        {
            var __cfgSType = typeof(CfgS<>).MakeGenericType(typeof(PerfConfig2UnManaged));
    ...
    private static CfgS<PerfConfig2UnManaged> ParseId(XmlElement configItem, ModS mod, string configName)
        {
            try
            {
