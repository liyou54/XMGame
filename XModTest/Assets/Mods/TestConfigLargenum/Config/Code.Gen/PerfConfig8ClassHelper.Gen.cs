...
public sealed class PerfConfig8ClassHelper : ConfigClassHelper<PerfConfig8, PerfConfig8UnManaged>
{
    ...
    static PerfConfig8ClassHelper()
    {
        ...
        CfgS<PerfConfig8UnManaged>.Table = new TblS(new ModS(__modName), __tableName);
    ...
    private static CfgS<PerfConfig8UnManaged> ParseId(XmlElement configItem, ModS mod, string configName, in ConfigParseContext context)
        {
            try
            {
