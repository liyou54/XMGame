...
public sealed class PerfConfig3ClassHelper : ConfigClassHelper<PerfConfig3, PerfConfig3UnManaged>
{
    ...
    static PerfConfig3ClassHelper()
    {
        ...
        CfgS<PerfConfig3UnManaged>.Table = new TblS(new ModS(__modName), __tableName);
    ...
    private static CfgS<PerfConfig3UnManaged> ParseId(XmlElement configItem, ModS mod, string configName, in ConfigParseContext context)
        {
            try
            {
