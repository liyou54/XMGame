...
/// <summary>
/// PerfConfig7 的配置加载辅助类，用于从 XML 反序列化（静态代码生成，无反射）。
/// </summary>
public sealed class PerfConfig7ClassHelper : ConfigClassHelper<PerfConfig7, PerfConfig7UnManaged>
{
    ...
    public PerfConfig7ClassHelper(IConfigDataCenter dataCenter)
        : base(dataCenter)
    {
    }
