...
public sealed class PerfConfig1ClassHelper : ConfigClassHelper<PerfConfig1, PerfConfig1UnManaged>
{
    ...
    static PerfConfig1ClassHelper()
    {
        ...
        CfgS<PerfConfig1UnManaged>.Table = new TblS(new ModS(__modName), __tableName);
    ...
    private static CfgS<PerfConfig1UnManaged> ParseId(XmlElement configItem, ModS mod, string configName, in ConfigParseContext context)
        {
            try
            {
