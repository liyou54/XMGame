...
public sealed class PerfConfig9ClassHelper : ConfigClassHelper<PerfConfig9, PerfConfig9UnManaged>
{
    ...
    static PerfConfig9ClassHelper()
    {
        ...
        CfgS<PerfConfig9UnManaged>.Table = new TblS(new ModS(__modName), __tableName);
    ...
    private static CfgS<PerfConfig9UnManaged> ParseId(XmlElement configItem, ModS mod, string configName, in ConfigParseContext context)
        {
            try
            {
