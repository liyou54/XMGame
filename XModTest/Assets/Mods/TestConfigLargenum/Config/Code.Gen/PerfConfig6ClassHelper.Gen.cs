...
public sealed class PerfConfig6ClassHelper : ConfigClassHelper<PerfConfig6, PerfConfig6UnManaged>
{
    ...
    static PerfConfig6ClassHelper()
    {
        ...
        CfgS<PerfConfig6UnManaged>.Table = new TblS(new ModS(__modName), __tableName);
    ...
    private static CfgS<PerfConfig6UnManaged> ParseId(XmlElement configItem, ModS mod, string configName, in ConfigParseContext context)
        {
            try
            {
